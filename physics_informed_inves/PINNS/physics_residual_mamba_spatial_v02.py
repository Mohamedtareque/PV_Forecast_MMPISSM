"""
Physics-Residual Power Mamba (Spatial V02) - Station 08 Spatial Integration

Key Constraint: Physics Isolation Principle
...
def run_comparative_benchmark(df, n_splits=2, custom_config=None):
    """Run spatial-aware comparative benchmark with Physics Isolation"""
    print(">>> Running Spatial 8-Way Benchmark (Target: K_PV, Physics Isolation)")
...
if __name__ == "__main__":
    print("Spatial Physics-Residual Mamba V02 Module")
    print(f"Default config: SpatialMambaConfigs")
